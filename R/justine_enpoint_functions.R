...
#' a list of refuse amounts and name as well as the corresponding food code and description. Refuse amounts correspond to the 
#' inedible portion of the food. For instance, searching for food code 557 (Chicken, broiler, meat, skin, giblets and neck) will return
...
#' get_yieldamount(foodCode = 557, lang = "fr")
...
#' a list of serving sizes as well as the corresponding food code and description. The conversion factor value is also given. This represents
#' the proportion of weight between cooked edible portion and raw edible portion. \href{https://www.researchgate.net/publication/327790633_Cooking_conversion_factor_of_commonly_consumed_Sri_Lankan_food_items#:~:text=Conversion%20factor%20is%20the%20proportion,water%20reduction%20and%20fat%20absorption.}{conversion factor} Refuse amounts correspond to the 
#'   
#'
#' @param apiKey Key to access the API. Can be retrieved from
#' <https://hc-sc.api.canada.ca/en/detail?api=cnf#!/Nutrient/get_nutrientamount>.
...
#' get_yieldamount(foodCode = 45, lang = "fr")
